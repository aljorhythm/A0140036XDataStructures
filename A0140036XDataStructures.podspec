#
#  Be sure to run `pod spec lint A0140036XDataStructures.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/cs3217/2018-ps1-aljorhythm.git", :tag => "#{s.version}" }
